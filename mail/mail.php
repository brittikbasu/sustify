...
$outgoingServerAddress      = 'smtp.strato.de'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'brittik.basu@sustify.de';
$sendingAccountPassword     = 'ZtJRSAzTSaFXhD5gSHvH';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'brittik.basu@sustify.de'; // REQUIRED value.
$recipientName              = 'Brittik Basu';             // REQUIRED value.
